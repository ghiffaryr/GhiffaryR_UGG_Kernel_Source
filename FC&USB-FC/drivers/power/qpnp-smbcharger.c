 ...
 *	if SDP is detected it will look at 900mA setting
 *		if set it will draw 900mA
						...
						enum power_supply_type type)
{
	...
	/*
	 * Type-C only supports STD(900), MEDIUM(2400) and HIGH(3000) current
...
static int smbchg_hw_init(struct smbchg_chip *chip)
{
	...
	/*
	 * control USB suspend via command bits and set correct 100/900mA
